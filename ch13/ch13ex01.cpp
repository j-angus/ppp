 ...
 *
 * defined and inmplemented in Graph.h, Graph.cpp
 *
 * I've based this on Circle initially, will try it based on Elipse next...
 *
 */
...
try
{
	...
	Simple_window win(tl,500,500,"ch13ex01"); // make a simple window
